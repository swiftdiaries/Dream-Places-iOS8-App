...
SWIFT_CLASS("_TtC21Dream_Places_To_Visit11AppDelegate")
...
SWIFT_CLASS("_TtC21Dream_Places_To_Visit19TableViewController")
...
SWIFT_CLASS("_TtC21Dream_Places_To_Visit14ViewController")
@interface ViewController : UIViewController <MKMapViewDelegate, CLLocationManagerDelegate>
@property (nonatomic) IBOutlet MKMapView * __null_unspecified map;
@property (nonatomic) CLLocationManager * __nonnull locationManager;
@property (nonatomic) CLLocationCoordinate2D newCoordinates;
@property (nonatomic, copy) NSString * __nonnull title1;
- (void)viewDidLoad;
